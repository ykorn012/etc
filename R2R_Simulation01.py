...
def sampling(index, k, uk = np.array([0, 0]), vp = np.array([0, 0, 0, 0, 0, 0]), initialVM = True):
    u1_p1 = uk[0]
    u2_p1 = uk[1]
    u_p1 = uk
    ...
    index_p1 = np.array([[index1_p1], [index2_p1]])

    k_p1 = np.array([[k1_p1], [k2_p1]])

    psi = np.array([u1_p1, u2_p1, v1_p1, v2_p1, v3_p1, v4_p1, v5_p1, v6_p1, index1_p1, index2_p1])
...
for k in range(1, N + 1): # range(101) = [0, 1, 2, ..., 100])
    ...
    result = sampling(index, k, uk_next, vk_next, True)
